...
RSS_FEEDS = {
    ...
    # ── Mubasher.info — Egypt's #1 financial portal (Arabic primary) ─────────
    "mubasher_ar": {
    ...
    # ── Al Borsa News (alborsaanews.com) — EGX-affiliated daily ──────────────
    "al_borsa_ar": {
    ...
    # ── Enterprise Press — institutional-grade English daily briefing ─────────
    "enterprise_press": {
    ...
    # ── Zawya (Refinitiv MENA) — Arabic + English ────────────────────────────
    "zawya_egypt_en": {
    ...
    # ── Argaam — Arabic financial portal covering EGX ────────────────────────
    "argaam_ar": {
