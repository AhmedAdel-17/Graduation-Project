...
logger = logging.getLogger("tradingagents.bull_researcher")
...
Now present your compelling bull argument, counter the bear's concerns, and provide your structured thesis."""
        ...
        _fallback_bull = type("_FallbackMsg", (), {
            "content": "Unable to construct bull thesis — LLM unavailable. Defaulting to neutral stance."
        })()
        response = safe_invoke(
            llm, prompt,
            fallback=_fallback_bull,
