...
logger = logging.getLogger("tradingagents.bear_researcher")
...
Now present your compelling bear argument, counter the bull's claims, and provide your structured thesis. Remember: AVOID/REDUCE recommendations only, NO SHORT SELLING."""
        ...
        _fallback_bear = type("_FallbackMsg", (), {
            "content": "Unable to construct bear thesis — LLM unavailable. Defaulting to neutral stance."
        })()
        response = safe_invoke(
            llm, prompt,
            fallback=_fallback_bear,
